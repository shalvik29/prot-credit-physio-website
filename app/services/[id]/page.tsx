    ...
    <div className="flex flex-col min-h-screen pt-32">
      ...
      {service.conditions && service.conditions.length > 0 && (
        <section className="py-16 px-4 sm:px-6 lg:px-8 bg-white-shade">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-navy-dark mb-8">Conditions Treated</h2>
      ...
      {/* CTA Section */}
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-navy-medium to-navy-dark text-white">
